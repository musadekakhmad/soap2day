    ...
    <div className="container mx-auto px-4 py-8 text-gray-300">
      <div className="bg-gray-800 p-8 rounded-xl shadow-lg">
        <h1 className="text-3xl md:text-4xl font-extrabold text-center mb-4 text-orange-400">
          Vegamovies: Your Ultimate Destination for Movie and TV Series Information
        </h1>
        <div className="mb-8 flex justify-center">
          <img
            src="https://live.staticflickr.com/65535/54777580906_77cfe0ccdf_b.jpg"
        ...
        <section className="mb-12">
          ...
          <p className="text-justify">
            We are committed to continuously innovating and adding new features that are relevant to user needs. We listen to feedback from our community and actively implement suggestions to improve this platform. This is a project that continues to evolve, and every update, whether small or large, is dedicated to you, our valuable users. We believe that with collaboration and the same spirit, we can make Your Vegamovies the number one site for all things related to movies and TV series.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-4 text-orange-300">
            How Your Vegamovies is Different
          </h2>
          <p className="mb-4 text-justify">
            Amidst the sea of Vegamoviess, Your Vegamovies stands out for several reasons. First, we prioritize the user experience. Our interface is designed to be minimalist and clean, free from annoying pop-up ads and unnecessary elements. We want you to focus on what matters most: movies and TV series.
          </p>
          <p className="mb-4 text-justify">
          ...
          <p className="mb-4 text-justify">
            Third, we not only present movies but also TV series. This makes Your Vegamovies a one-stop-shop for all your visual entertainment needs. You don't have to switch to other platforms to get information about your favorite TV shows. Everything is here, under one roof.
          </p>
          <p className="text-justify">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-justify">
            In addition, we ensure that all our content is accessible from various devices, whether it's a desktop, tablet, or mobile phone. With a responsive design, Your Vegamovies will look and function perfectly on any screen. This is important because most internet users today access content via mobile devices.
          </p>
          <p className="text-justify">
